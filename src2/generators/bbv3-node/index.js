...
function writeFiles() {
   ...
   this.copy(`${src}/bot-registration.json`, `${root}/bot-registration.json`);
   this.copy(`${src}/bot-registration.parameters.json`, `${root}/bot-registration.parameters.json`);
   this.copy(`${src}/appInsigthsApiAccess.ps1`, `${root}/botapp.json`);
}
