...
function writeFiles() {
   ...
   this.fs.copyTpl(`${src}/app.sln`, `${root}/${this.botName}.sln`, tokens);

   // Web App project
   src = `${this.sourceRoot()}/src/app`;
   root = `${this.botName}/src/${this.botName}`;
   ...
   this.fs.copyTpl(`${src}/app.csproj`, `${root}/${this.botName}.csproj`, tokens);   
   ...
   root = `${this.botName}/test/${this.botName}.Tests`;

   this.fs.copyTpl(`${src}/app.Tests.csproj`, `${root}/${this.botName}.Tests.csproj`, tokens);
