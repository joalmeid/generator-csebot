...
function init() {
   ...
   this.log(yosay(`Welcome to CSE bot generator powered by Donovan's team generator ${package.version}`));
}
...
function input() {
   ...
   return this.prompt([
      ...
      this.botName = util.reconcileValue(answers.botName, cmdLnInput.botName, ``);
